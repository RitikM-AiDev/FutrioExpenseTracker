      ...
      <div className="login-card-wrapper">
        <div className="login-card">
          <div className="login-header">
            ...
            <p className="login-subtitle">Your AI Expence tracker</p>
          </div>
          ...
          <div className="social-container">
            <button type="button" className="social-button" aria-label="Authenticate with GitHub">
            ...
            <button type="button" className="social-button" aria-label="Authenticate with Google">
              <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="signup-redirect">
            New pilot?
            <a href="#signup" className="signup-link">Register Futrio AI</a>
          </div>
        </div>
      </div>
    </div>
